...
// Lazy load the Jupiter Trading Modal to improve initial load time
const JupiterTradingModal = lazy(() => import('./components/JupiterTradingModal'))
...
function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', paddingBottom: 72 }}>
      ...
      {/* Jupiter Trading Modal - Lazy loaded for performance */}
      {tradingModalOpen && (
